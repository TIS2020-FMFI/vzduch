 ...
 */
 (function ( global, factory ) {
	...
	if ( typeof define !== 'undefined' && define.amd ) {
		define('canvgModule', [ 'static/js/Highcharts/code/lib/rgbcolor', 'stackblur' ], factory );
	}

	// ...or as browserify
	else if ( typeof module !== 'undefined' && module.exports ) {
		module.exports = factory( require( 'static/js/Highcharts/code/lib/rgbcolor' ), require( 'stackblur' ) );
	}
